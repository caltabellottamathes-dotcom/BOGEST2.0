...
export const SITE_IMAGE_POSITIONS = [
  ...
  { key: 'takeaway.story.0', label: 'Traiteur — klassiekers', pages: ['takeaway'], default: 'https://media.base44.com/images/public/6a062d5a5c4241c6b2404e25/8696324df_Make_this_photo_look_more_202605150157.jpg' },
  { key: 'takeaway.story.1', label: 'Traiteur — locatie', pages: ['takeaway'], default: `${SQ}/b7c2edca-9db5-43c2-b109-4cc33197dfbe/veranda+hasselt.jpeg` },
  { key: 'takeaway.story.2', label: 'Traiteur — afhalen', pages: ['takeaway'], default: `${SQ}/1756906798052-P24QWA3M58JWMGOWHVBD/399841843_793829846088881_1062638734165438461_n.jpg` },
  { key: 'takeaway.story.3', label: 'Traiteur — formule', pages: ['takeaway'], default: `${SQ}/1756906799926-VML5QXWO8V6D1NYAO2ZA/909af4c2-7392-4bbc-af18-2ea890714ecd-1.jpg` },
  { key: 'takeaway.story.4', label: 'Traiteur — chef', pages: ['takeaway'], default: `${SQ}/1756906793880-RYMZN9OWYYUERUL16C6K/B4E94C22-3656-4874-A66B-CEA4D674F86D.jpeg` },
  { key: 'takeaway.pkg.0', label: 'Cadeaupakket — Wijn', pages: ['takeaway'], default: 'https://media.base44.com/images/public/6a62118af65a96c8b1eb8e17/b7bb6162b_generated_image.png' },
  { key: 'takeaway.pkg.1', label: 'Cadeaupakket — Gin', pages: ['takeaway'], default: 'https://media.base44.com/images/public/6a62118af65a96c8b1eb8e17/b7bb6162b_generated_image.png' },
  { key: 'takeaway.pkg.2', label: 'Cadeaupakket — Op maat', pages: ['takeaway'], default: 'https://media.base44.com/images/public/6a62118af65a96c8b1eb8e17/b7bb6162b_generated_image.png' },
