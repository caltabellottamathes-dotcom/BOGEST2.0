    ...
    <div className="w-full">
      ...
      <section className="w-full px-6 md:px-10 lg:px-16 pt-16 md:pt-20 pb-24">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          {cards.map((c, i) => (
            <Link key={c.to} to={c.to} className={`group relative overflow-hidden rounded-2xl aspect-[4/5] block shadow-2xl ${i === 0 ? 'md:col-span-7 z-10' : 'md:col-span-5 md:mt-20 md:-ml-12 z-20'}`}>
                <img
                  src={c.image}
                  alt={c.title}
