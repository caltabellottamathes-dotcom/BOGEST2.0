...
import { ArrowRight, Quote, Instagram as InstagramIcon, ExternalLink } from 'lucide-react';
...
export default function About() {
  ...
  useEffect(() => {
    base44.entities.InstagramPost.list('-posted_at', 6)
      .then(setPosts)
      .catch(() => {});
  }, []);
  ...
  const story = [
    ...
    },
    {
      ...
      image: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc715a25577/1756906795532-RIXDIIHXCS7LTVKIKUB0/dentrecote-borgloon5.jpg',
    },
    {
      num: '03',
      title: t('about_s3_title'),
      text: t('about_s3_text'),
      image: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc715a25577/b7c2edca-9db5-43c2-b109-4cc33197dfbe/veranda+hasselt.jpeg',
    },
    {
      num: '04',
      title: t('about_s4_title'),
      text: t('about_s4_text'),
      image: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc715a25577/04917c77-6ebc-4470-83fb-a2abc637268b/zolder+veranda.jpeg',
    },
  ];
  ...
  const pillars = [
    {
      ...
      image: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc715a25577/1756906799922-SLXI4OSI7W3KWGKE3UFY/5a7c094c-9679-410a-bbc5-5f8c663d8a14.JPG',
    },
    {
      num: '02',
      title: t('about_p2_title'),
      text: t('about_p2_text'),
      image: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc715a25577/1756906799913-Y5ZEKPI4I2XXUTYC8W3T/d2db3621-8f9b-45f1-95c8-498c24ed15c3-1.jpg',
    },
    {
      num: '03',
      title: t('about_p3_title'),
      text: t('about_p3_text'),
      image: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc715a25577/426ec0ed-f1b6-4eb0-90d5-ad7cea634e7c/7B0C379C-A65C-400B-83D7-C140E27E6ABF_1_201_a.jpeg',
    },
  ];

  const locations = [
    { city: 'Hasselt', sub: 'Wimmertingen', slug: 'hasselt', img: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc7e15a25577/b7c2edca-9db5-43c2-b109-4cc33197dfbe/veranda+hasselt.jpeg' },
    { city: 'Borgloon', sub: 'Graathempoort', slug: 'borgloon', img: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc7e15a25577/ba4c98fb-2ded-4472-88d3-e42960e519bc/veranda+borgloon.jpeg' },
    { city: 'Heusden-Zolder', sub: 'Stationsstraat', slug: 'heusden-zolder', img: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc715a25577/04917c77-6ebc-4470-83fb-a2abc637268b/zolder+veranda.jpeg' },
    { city: 'Lommel', sub: t('about_coming_soon'), slug: null, img: 'https://images.squarespace-cdn.com/content/v1/68b84525485ccc7e15a25577/04917c77-6ebc-4470-83fb-a2abc637268b/zolder+veranda.jpeg', soon: true },
  ];
          ...
          <SectionReveal className="mb-10 flex flex-col md:flex-row md:items-end md:justify-between gap-5">
            <div>
              ...
              <p className="font-body text-sm text-muted-foreground mt-3 max-w-md leading-relaxed">
                Sfeerbeelden, gerechten en momenten vanuit al onze vestigingen — dagelijks bijgewerkt.
              </p>
            </div>
            <Link to="/instagram"
                ...
                >
                  ...
                  <div className="absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="flex items-center justify-between">
                      <span className="font-body text-[9px] tracking-[0.2em] uppercase text-primary">{post.location_name}</span>
