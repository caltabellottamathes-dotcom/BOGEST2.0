 ...
 *
 * Sits as a square floating card on the right side, layered above the
 * ElevenLabs widget. Paused by default showing its first frame — pure video,
 * no icons or overlays. Clicking starts playback and the video expands
 * (larger on desktop); when it finishes it resets to the first frame and
 * shrinks back.
 */
const VIDEO_SRC =
