...
const HOST_STRINGS = {
  nl: {
    ...
    proactive_facts: [
      ...
      { msg: 'U vindt Bogèst ook op Facebook en Instagram — volg uw favoriete vestiging voor sfeer, weekspecials en momenten achter de schermen.', actions: [{ label: 'Facebook', url: 'https://www.facebook.com/bogesthasselt' }, { label: 'Instagram Hasselt', url: 'https://www.instagram.com/bogesthasselt' }, { label: 'Instagram Borgloon', url: 'https://www.instagram.com/bogestborgloon' }] },
      ...
      { msg: 'De naam "Bogèst" komt van "Beau Geste" — een mooi gebaar. Want bij ons is aan tafel zitten meer dan alleen eten — het is een gebaar van gastvrijheid.' },
  ...
  fr: {
    title: 'Demandez à Bogèst',
    assistant: 'Demandez à Bogèst',
    placeholder: 'Posez votre question...',
    footer_text: 'Demandez à Bogèst · Réservations via',
    footer_link: 'le site',
    fab_label: 'Bogèst',
    ...
    entry_explore: 'Flâner par vous-même',
    ...
    proactive_facts: [
      ...
      { msg: 'Retrouvez Bogèst sur Facebook et Instagram — suivez votre établissement préféré pour l\'ambiance, les specials et les coulisses.', actions: [{ label: 'Facebook', url: 'https://www.facebook.com/bogesthasselt' }, { label: 'Instagram Hasselt', url: 'https://www.instagram.com/bogesthasselt' }, { label: 'Instagram Borgloon', url: 'https://www.instagram.com/bogestborgloon' }] },
      ...
      { msg: 'Le nom "Bogèst" vient de "Beau Geste" — un beau geste. Parce qu\'un repas chez nous, c\'est plus qu\'une assiette — c\'est un geste d\'hospitalité.' },
  ...
  en: {
    title: 'Ask Bogèst',
    assistant: 'Ask Bogèst',
    placeholder: 'Ask your question...',
    footer_text: 'Ask Bogèst · Reservations via',
    ...
    entry_explore: 'Have a look around',
    ...
    proactive_facts: [
      ...
      { msg: 'You\'ll find Bogèst on Facebook and Instagram too — follow your favourite location for atmosphere, weekly specials and behind-the-scenes moments.', actions: [{ label: 'Facebook', url: 'https://www.facebook.com/bogesthasselt' }, { label: 'Instagram Hasselt', url: 'https://www.instagram.com/bogesthasselt' }, { label: 'Instagram Borgloon', url: 'https://www.instagram.com/bogestborgloon' }] },
      ...
      { msg: 'The name "Bogèst" comes from "Beau Geste" — a beautiful gesture. Because a meal with us is more than just eating — it\'s a gesture of hospitality.' },
  ...
  return (
    <div className="relative flex-shrink-0" style={{ width: px, height: px }}>
      <div className="w-full h-full rounded-full overflow-hidden"
        style={{ border: '1.5px solid rgba(200,163,89,0.45)' }}>
...
function InstagramCard({ post }) {
  return (
    <a href={post.permalink || '#'} target="_blank" rel="noopener noreferrer"
      ...
      style={{ border: '1px solid rgba(200,163,89,0.30)' }}>
      <div className="w-full h-40" style={{ background: 'rgba(255,255,255,0.06)' }}>
...
function UserBubble({ content, isDark }) {
  return (
    <div className="flex justify-end">
      <div className="max-w-[78%] px-4 py-2.5 rounded-2xl rounded-tr-md" style={{ background: isDark ? 'rgba(200,163,89,0.16)' : 'rgba(107,122,63,0.14)', border: '1px solid ' + (isDark ? 'rgba(200,163,89,0.34)' : 'rgba(107,122,63,0.30)'), backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)' }}>
...
function EntryButton({ icon: Icon, label, sub, isDark, onClick, variant }) {
  ...
  let style;
  if (isPrimary) {
    style = { background: isDark ? 'rgba(200,163,89,0.14)' : 'rgba(107,122,63,0.10)', border: '1px solid rgba(200,163,89,0.50)' };
  } else if (isGhost) {
  ...
  return (
    <button onClick={onClick}
      ...
      <span className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center transition-colors"
        style={{ background: isPrimary ? 'rgba(200,163,89,0.20)' : isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.035)', border: isPrimary ? '1px solid rgba(200,163,89,0.35)' : isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(74,83,32,0.14)' }}>
      ...
      <motion.div initial={{ opacity: 0, scale: 0.94, y: 20 }} animate={frameReady ? { opacity: 1, scale: 1, y: 0 } : { opacity: 0, scale: 0.94, y: 20 }} exit={{ opacity: 0, scale: 0.96, y: 16 }}
        ...
        <div className="pointer-events-auto w-full rounded-[24px] overflow-hidden relative flex flex-col sm:flex-row"
          ...
          <div className="relative flex-1 flex flex-col px-6 sm:px-8 py-6 overflow-y-auto">
            ...
            <div className="h-px w-10 mb-5" style={{ background: isDark ? 'rgba(200,163,89,0.45)' : 'rgba(107,122,63,0.40)' }} />
              ...
              {proactiveMsg && (
                isMobile ? (
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
                    className="fixed bottom-[100px] right-[150px] z-[60] cursor-pointer"
          ...
          <>
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: isDark ? '0 28px 72px rgba(80,50,0,0.60), 0 0 0 1px rgba(200,163,89,0.15)' : '0 28px 72px rgba(0,0,0,0.20), 0 0 0 1px rgba(74,83,32,0.10)',
              }}
            >
