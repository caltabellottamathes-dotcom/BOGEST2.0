    ...
    <>
      ...
      <div data-bb-ui className="fixed bottom-5 left-5 z-[99998] flex items-center gap-2">
        <button
          ...
          style={{
            background: editMode ? 'hsl(var(--primary))' : 'rgba(26,24,20,0.72)',
            color: editMode ? '#1a1812' : 'rgba(255,255,255,0.92)',
            border: editMode ? '1px solid hsl(var(--primary))' : '1px solid hsl(var(--primary) / 0.30)',
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full font-body text-[11px] tracking-[0.25em] uppercase transition-all duration-300 hover:border-primary/50"
          style={{
      ...
      <AnimatePresence>
        {editMode && (
          <motion.div
            ...
            style={{ background: 'rgba(26,24,20,0.78)', border: '1px solid hsl(var(--primary) / 0.30)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)' }}
          >
      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            style={{ background: 'hsl(var(--primary))', color: '#1a1812' }}
          >
        ...
        {picker && (
          ...
          >
            <motion.div
              ...
              style={{ background: 'hsl(25 6% 9%)', border: '1px solid hsl(var(--primary) / 0.22)', boxShadow: '0 30px 80px rgba(0,0,0,0.6)' }}
            >
              {/* Header */}
